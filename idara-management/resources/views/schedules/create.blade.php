...
@section('title', 'Ongeza kwenye Ratiba')

@section('content')
    <h1 class="text-lg font-semibold mb-6">Ongeza kwenye Ratiba - {{ $department->name }}</h1>

    <form method="POST" action="{{ route('departments.schedules.store', $department) }}"
